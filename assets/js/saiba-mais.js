...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Modal Consultoria Jurídica
    const btnConsultoria = document.querySelector('.btn-consultoria-juridica');
    if (btnConsultoria) {
        btnConsultoria.addEventListener('click', function () {
    ...
    // Modal Direito Societário
    const btnSocietario = document.querySelector('.btn-direito-societario');
    if (btnSocietario) {
        btnSocietario.addEventListener('click', function () {
            const existingModal = document.querySelector('.modal-overlay');
            if (existingModal) existingModal.remove();
    ...
    // Modal Direito Trabalhista para Empresas
    const btnTrabalhista = document.querySelector('.btn-direito-trabalhista-empresa');
    if (btnTrabalhista) {
        btnTrabalhista.addEventListener('click', function () {
            const existingModal = document.querySelector('.modal-overlay');
            if (existingModal) existingModal.remove();
    ...
    // Modal Escritório - Saiba Mais Desktop
    const btnEscritorioDesktop = document.querySelector('.btn-escritorio-saiba-mais-desktop');
    if (btnEscritorioDesktop) {
        btnEscritorioDesktop.addEventListener('click', function () {
            const existingModal = document.querySelector('.modal-overlay');
            if (existingModal) existingModal.remove();
    ...
    // Modal Escritório - Saiba Mais Tablet
    const btnEscritorioTablet = document.querySelector('.btn-escritorio-saiba-mais-tablet');
    if (btnEscritorioTablet) {
        btnEscritorioTablet.addEventListener('click', function () {
            const existingModal = document.querySelector('.modal-overlay');
            if (existingModal) existingModal.remove();
                ...
                <div class="modal-content">
                    ...
                    <div class="descricao-caixa-areaAtuacao">
                        ...
                        <p class="texto-modal">
                            ...
                            Direitos das Pessoa com Autismo: espaços de acolhimento, orientação estratégica e atuação firme
